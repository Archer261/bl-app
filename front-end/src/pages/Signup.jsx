...
const SignupPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        axios
            .post('/api/login/signup', { username, email, password })
            .then((response) => {
                            ...
                            <form onSubmit={handleSubmit} className="mt-8 grid grid-cols-6 gap-6">
                                ...
                                <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                                    ...
                                    <p className="mt-4 text-sm text-gray-500 sm:mt-0">
                                        ...
                                        <Link to="/login" className="font-medium text-indigo-600 hover:text-indigo-500">  <p className="text-gray-700 underline">Log in </p></Link>.
                                    </p>
                                </div>
                            </form>
                        </div>
